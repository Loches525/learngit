...
class Request(object):
    ...
    def add_cookies(self):
        cookies = self.header.get('Cookies', '')
        kvs = cookies.split('; ')
        log('cookies', kvs)
        for kv in kvs:
            if '=' in kvs:
...
# def main():
#     with open(r'F:\weiyundiskDownload\web课3框架解释,model解释\上课预习3\User.txt', 'w+', encoding='utf-8') as f:
#         s = f.read(1000)
...
#             "password": "123"
#         }
#         s_meta = json.dumps(dict, indent=2, ensure_ascii=False)
#         print(type(s_meta))
#         print(s_meta)
#         if s_meta in s:
#             print('ok')
